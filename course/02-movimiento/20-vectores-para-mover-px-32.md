...
Hoy vas a **ejecutar de forma segura avance, retroceso, laterales y giros**. Al terminar podrás demostrarlo con una explicación, un dato o un comportamiento observable; no basta con decir “funcionó”.
...
[Lección 19: Ruedas Mecanum y fuerzas diagonales](19-ruedas-mecanum-y-fuerzas-diagonales.md). Debes poder explicar su idea central y repetir su prueba segura antes de continuar.
...
El tema de hoy es **vector, suma, traslación, rotación y STOP**. En lenguaje cotidiano, buscamos una forma fiable de ejecutar de forma segura avance, retroceso, laterales y giros. La palabra “fiable” importa: una sola coincidencia puede ser suerte; una explicación científica conecta una causa, una prueba y un resultado que otra persona podría repetir.
...
- **Vector:** idea principal que podrás reconocer en la actividad.
...
1. ¿Qué esperas observar cuando logres ejecutar de forma segura avance, retroceso, laterales y giros y qué mecanismo produciría ese resultado?
...
2. **Trazar.** Señala la ruta entrada → proceso → salida relacionada con vector, suma, traslación, rotación y STOP. Si no puedes justificar un pin, consulta el mapa; no adivines.
3. **Predecir.** Elige un resultado concreto y una señal de parada. Di qué variable cambiarás y cuáles permanecerán iguales.
4. **Probar.** Vas a probar seis movimientos con ruedas elevadas y luego dos en piso despejado. Haz un solo cambio. Observa antes de repetir y mantén accesible la forma de detener la prueba.
5. **Comprobar.** El resultado que permite continuar es: movimientos reconocibles, baja velocidad y STOP dominante. Si no aparece, apaga cuando corresponda y pasa a “Si no funciona”.
...
Abre [20-vectores-para-mover-px-32.ino](../../code/educational/20-vectores-para-mover-px-32/20-vectores-para-mover-px-32.ino). Antes de cargarlo, localiza `setup()`, `loop()` y la línea que representa **vector**. Lee el programa de arriba abajo y predice su salida.
...
El resultado normal es **movimientos reconocibles, baja velocidad y STOP dominante**. Puede haber variación por tolerancias, superficie, luz, fricción, carga, eco o tiempos del programa. Una variación pequeña y repetible es información; un salto grande, un reinicio, una lectura imposible o un movimiento inesperado exige STOP.
...
- Cuéntale con tus palabras qué significa **vector** y dónde aparece en PX-32.
...
Hoy aprendiste a **ejecutar de forma segura avance, retroceso, laterales y giros** y lo conectaste con **vector, suma, traslación, rotación y STOP**. Pudiste observar movimientos reconocibles, baja velocidad y STOP dominante. La regla de seguridad es cambiar conexiones únicamente sin energía y usar `STOP` ante información dudosa. La próxima sesión será la [Lección 21: La luz transporta energía](../03-infrarrojo/21-la-luz-transporta-energia.md).
