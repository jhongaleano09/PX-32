# Lección 50 — Radio: otra región del espectro

## 1. Tu misión de hoy

Hoy vas a **comparar radio, infrarrojo y luz visible sin confundirlas con sonido**. Al terminar podrás demostrarlo con una explicación, un dato o un comportamiento observable; no basta con decir “funcionó”.
...
[Lección 22: El espectro electromagnético](../03-infrarrojo/22-el-espectro-electromagnetico.md), [Lección 49: Evitar obstáculos](../05-ultrasonido/49-evitar-obstaculos.md). Debes poder explicar su idea central y repetir su prueba segura antes de continuar.
...
El tema de hoy es **onda de radio, frecuencia, antena y modulación**. En lenguaje cotidiano, buscamos una forma fiable de comparar radio, infrarrojo y luz visible sin confundirlas con sonido. La palabra “fiable” importa: una sola coincidencia puede ser suerte; una explicación científica conecta una causa, una prueba y un resultado que otra persona podría repetir.
...
- **Onda de radio:** idea principal que podrás reconocer en la actividad.
...
1. ¿Qué esperas observar cuando logres comparar radio, infrarrojo y luz visible sin confundirlas con sonido y qué mecanismo produciría ese resultado?
...
2. **Trazar.** Señala la ruta entrada → proceso → salida relacionada con onda de radio, frecuencia, antena y modulación. Si no puedes justificar un pin, consulta el mapa; no adivines.
3. **Predecir.** Elige un resultado concreto y una señal de parada. Di qué variable cambiarás y cuáles permanecerán iguales.
4. **Probar.** Vas a ordenar casos de comunicación por medio físico y alcance. Haz un solo cambio. Observa antes de repetir y mantén accesible la forma de detener la prueba.
5. **Comprobar.** El resultado que permite continuar es: radio identificada como onda electromagnética que no requiere aire. Si no aparece, apaga cuando corresponda y pasa a “Si no funciona”.
...
El resultado normal es **radio identificada como onda electromagnética que no requiere aire**. Puede haber variación por tolerancias, superficie, luz, fricción, carga, eco o tiempos del programa. Una variación pequeña y repetible es información; un salto grande, un reinicio, una lectura imposible o un movimiento inesperado exige STOP.
...
- Cuéntale con tus palabras qué significa **onda de radio** y dónde aparece en PX-32.
...
Hoy aprendiste a **comparar radio, infrarrojo y luz visible sin confundirlas con sonido** y lo conectaste con **onda de radio, frecuencia, antena y modulación**. Pudiste observar radio identificada como onda electromagnética que no requiere aire. La regla de seguridad es cambiar conexiones únicamente sin energía y usar `STOP` ante información dudosa. La próxima sesión será la [Lección 51: Todo enlace necesita un protocolo](51-todo-enlace-necesita-un-protocolo.md).
