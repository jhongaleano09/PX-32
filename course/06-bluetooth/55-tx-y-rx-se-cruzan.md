# Lección 55 — TX y RX se cruzan

## 1. Tu misión de hoy

Hoy vas a **trazar B_TX→D19/RX1 y B_RX←D18/TX1**. Al terminar podrás demostrarlo con una explicación, un dato o un comportamiento observable; no basta con decir “funcionó”.
...
[Lección 54: UART: hablar por turnos y a la misma velocidad](54-uart-hablar-por-turnos-y-a-la-misma-velocidad.md). Debes poder explicar su idea central y repetir su prueba segura antes de continuar.
...
El tema de hoy es **transmisión, recepción, RX1 y TX1**. En lenguaje cotidiano, buscamos una forma fiable de trazar B_TX→D19/RX1 y B_RX←D18/TX1. La palabra “fiable” importa: una sola coincidencia puede ser suerte; una explicación científica conecta una causa, una prueba y un resultado que otra persona podría repetir.
...
- **Transmisión:** idea principal que podrás reconocer en la actividad.
...
1. ¿Qué esperas observar cuando logres trazar B_TX→D19/RX1 y B_RX←D18/TX1 y qué mecanismo produciría ese resultado?
...
1. **Preparar.** Coloca PX-32 estable, identifica HW-001, HW-002, HW-011 y confirma con el adulto que la energía está en el estado seguro. Continúa solo si no hay cables sueltos, daño, calor u olor.
2. **Trazar.** Señala la ruta entrada → proceso → salida relacionada con transmisión, recepción, RX1 y TX1. Si no puedes justificar un pin, consulta el mapa; no adivines.
3. **Predecir.** Elige un resultado concreto y una señal de parada. Di qué variable cambiarás y cuáles permanecerán iguales.
4. **Probar.** Vas a inspeccionar el cableado apagado y seguir ambas flechas. Haz un solo cambio. Observa antes de repetir y mantén accesible la forma de detener la prueba.
5. **Comprobar.** El resultado que permite continuar es: rutas cruzadas correctas sin coexistencia con E_TX/E_RX. Si no aparece, apaga cuando corresponda y pasa a “Si no funciona”.
...
Abre [55-tx-y-rx-se-cruzan.ino](../../code/educational/55-tx-y-rx-se-cruzan/55-tx-y-rx-se-cruzan.ino). Antes de cargarlo, localiza `setup()`, `loop()` y la línea que representa **transmisión**. Lee el programa de arriba abajo y predice su salida.
...
El resultado normal es **rutas cruzadas correctas sin coexistencia con E_TX/E_RX**. Puede haber variación por tolerancias, superficie, luz, fricción, carga, eco o tiempos del programa. Una variación pequeña y repetible es información; un salto grande, un reinicio, una lectura imposible o un movimiento inesperado exige STOP.
...
- Cuéntale con tus palabras qué significa **transmisión** y dónde aparece en PX-32.
...
Hoy aprendiste a **trazar B_TX→D19/RX1 y B_RX←D18/TX1** y lo conectaste con **transmisión, recepción, RX1 y TX1**. Pudiste observar rutas cruzadas correctas sin coexistencia con E_TX/E_RX. La regla de seguridad es cambiar conexiones únicamente sin energía y usar `STOP` ante información dudosa. La próxima sesión será la [Lección 56: Recibir una letra](56-recibir-una-letra.md).
