# Lección 52 — Qué hace Bluetooth

## 1. Tu misión de hoy

Hoy vas a **explicar qué resuelve Bluetooth antes de abrir una aplicación**. Al terminar podrás demostrarlo con una explicación, un dato o un comportamiento observable; no basta con decir “funcionó”.
...
[Lección 51: Todo enlace necesita un protocolo](51-todo-enlace-necesita-un-protocolo.md). Debes poder explicar su idea central y repetir su prueba segura antes de continuar.
...
El tema de hoy es **Bluetooth, emparejamiento, enlace y alcance**. En lenguaje cotidiano, buscamos una forma fiable de explicar qué resuelve Bluetooth antes de abrir una aplicación. La palabra “fiable” importa: una sola coincidencia puede ser suerte; una explicación científica conecta una causa, una prueba y un resultado que otra persona podría repetir.
...
- **Bluetooth:** idea principal que podrás reconocer en la actividad.
...
1. ¿Qué esperas observar cuando logres explicar qué resuelve Bluetooth antes de abrir una aplicación y qué mecanismo produciría ese resultado?
...
2. **Trazar.** Señala la ruta entrada → proceso → salida relacionada con Bluetooth, emparejamiento, enlace y alcance. Si no puedes justificar un pin, consulta el mapa; no adivines.
3. **Predecir.** Elige un resultado concreto y una señal de parada. Di qué variable cambiarás y cuáles permanecerán iguales.
4. **Probar.** Vas a identificar dispositivo, emparejar con adulto y observar estado sin mover el robot. Haz un solo cambio. Observa antes de repetir y mantén accesible la forma de detener la prueba.
5. **Comprobar.** El resultado que permite continuar es: módulo reconocido o limitación documentada sin cambiar comandos AT. Si no aparece, apaga cuando corresponda y pasa a “Si no funciona”.
...
El resultado normal es **módulo reconocido o limitación documentada sin cambiar comandos AT**. Puede haber variación por tolerancias, superficie, luz, fricción, carga, eco o tiempos del programa. Una variación pequeña y repetible es información; un salto grande, un reinicio, una lectura imposible o un movimiento inesperado exige STOP.
...
- Cuéntale con tus palabras qué significa **Bluetooth** y dónde aparece en PX-32.
...
Hoy aprendiste a **explicar qué resuelve Bluetooth antes de abrir una aplicación** y lo conectaste con **Bluetooth, emparejamiento, enlace y alcance**. Pudiste observar módulo reconocido o limitación documentada sin cambiar comandos AT. La regla de seguridad es cambiar conexiones únicamente sin energía y usar `STOP` ante información dudosa. La próxima sesión será la [Lección 53: Conocer el HC-02 y su zócalo](53-conocer-el-hc-02-y-su-zocalo.md).
