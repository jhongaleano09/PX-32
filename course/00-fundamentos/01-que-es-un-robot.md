...
Hoy vas a **explicar por qué PX-32 es un robot y clasificar seis piezas por su función**. Al terminar podrás demostrarlo con una explicación, un dato o un comportamiento observable; no basta con decir “funcionó”.
...
Ninguno: esta es la entrada al curso.
...
El tema de hoy es **robot, sistema, entrada, proceso y salida**. En lenguaje cotidiano, buscamos una forma fiable de explicar por qué PX-32 es un robot y clasificar seis piezas por su función. La palabra “fiable” importa: una sola coincidencia puede ser suerte; una explicación científica conecta una causa, una prueba y un resultado que otra persona podría repetir.
...
- **Robot:** idea principal que podrás reconocer en la actividad.
...
1. ¿Qué esperas observar cuando logres explicar por qué PX-32 es un robot y clasificar seis piezas por su función y qué mecanismo produciría ese resultado?
...
1. **Preparar.** Coloca PX-32 estable, identifica PX-32 apagado y confirma con el adulto que la energía está en el estado seguro. Continúa solo si no hay cables sueltos, daño, calor u olor.
2. **Trazar.** Señala la ruta entrada → proceso → salida relacionada con robot, sistema, entrada, proceso y salida. Si no puedes justificar un pin, consulta el mapa; no adivines.
3. **Predecir.** Elige un resultado concreto y una señal de parada. Di qué variable cambiarás y cuáles permanecerán iguales.
4. **Probar.** Vas a recorrer visualmente el robot y construir una cadena sensor → programa → actuador. Haz un solo cambio. Observa antes de repetir y mantén accesible la forma de detener la prueba.
5. **Comprobar.** El resultado que permite continuar es: una clasificación razonada y al menos una duda marcada sin adivinar. Si no aparece, apaga cuando corresponda y pasa a “Si no funciona”.
...
El resultado normal es **una clasificación razonada y al menos una duda marcada sin adivinar**. Puede haber variación por tolerancias, superficie, luz, fricción, carga, eco o tiempos del programa. Una variación pequeña y repetible es información; un salto grande, un reinicio, una lectura imposible o un movimiento inesperado exige STOP.
...
- Cuéntale con tus palabras qué significa **robot** y dónde aparece en PX-32.
...
Hoy aprendiste a **explicar por qué PX-32 es un robot y clasificar seis piezas por su función** y lo conectaste con **robot, sistema, entrada, proceso y salida**. Pudiste observar una clasificación razonada y al menos una duda marcada sin adivinar. La regla de seguridad es cambiar conexiones únicamente sin energía y usar `STOP` ante información dudosa. La próxima sesión será la [Lección 02: Inventario razonado de PX-32](02-inventario-razonado-de-px-32.md).
