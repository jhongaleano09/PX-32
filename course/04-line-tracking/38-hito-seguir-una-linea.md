...
Hoy vas a **seguir una pista corta con baja velocidad y recuperar STOP**. Al terminar podrás demostrarlo con una explicación, un dato o un comportamiento observable; no basta con decir “funcionó”.
...
[Lección 37: De la medición a la orden](37-de-la-medicion-a-la-orden.md). Debes poder explicar su idea central y repetir su prueba segura antes de continuar.
...
El tema de hoy es **realimentación, corrección y velocidad de prueba**. En lenguaje cotidiano, buscamos una forma fiable de seguir una pista corta con baja velocidad y recuperar STOP. La palabra “fiable” importa: una sola coincidencia puede ser suerte; una explicación científica conecta una causa, una prueba y un resultado que otra persona podría repetir.
...
- **Realimentación:** idea principal que podrás reconocer en la actividad.
...
1. ¿Qué esperas observar cuando logres seguir una pista corta con baja velocidad y recuperar STOP y qué mecanismo produciría ese resultado?
...
2. **Trazar.** Señala la ruta entrada → proceso → salida relacionada con realimentación, corrección y velocidad de prueba. Si no puedes justificar un pin, consulta el mapa; no adivines.
3. **Predecir.** Elige un resultado concreto y una señal de parada. Di qué variable cambiarás y cuáles permanecerán iguales.
4. **Probar.** Vas a ensayar con ruedas elevadas, luego en una pista de 20–30 mm y área libre. Haz un solo cambio. Observa antes de repetir y mantén accesible la forma de detener la prueba.
5. **Comprobar.** El resultado que permite continuar es: correcciones frecuentes, velocidad moderada y detención al perder la línea. Si no aparece, apaga cuando corresponda y pasa a “Si no funciona”.
...
Abre [38-hito-seguir-una-linea.ino](../../code/educational/38-hito-seguir-una-linea/38-hito-seguir-una-linea.ino). Antes de cargarlo, localiza `setup()`, `loop()` y la línea que representa **realimentación**. Lee el programa de arriba abajo y predice su salida.
...
El resultado normal es **correcciones frecuentes, velocidad moderada y detención al perder la línea**. Puede haber variación por tolerancias, superficie, luz, fricción, carga, eco o tiempos del programa. Una variación pequeña y repetible es información; un salto grande, un reinicio, una lectura imposible o un movimiento inesperado exige STOP.
...
- Cuéntale con tus palabras qué significa **realimentación** y dónde aparece en PX-32.
...
Hoy aprendiste a **seguir una pista corta con baja velocidad y recuperar STOP** y lo conectaste con **realimentación, corrección y velocidad de prueba**. Pudiste observar correcciones frecuentes, velocidad moderada y detención al perder la línea. La regla de seguridad es cambiar conexiones únicamente sin energía y usar `STOP` ante información dudosa. La próxima sesión será la [Lección 39: El sonido es una onda mecánica](../05-ultrasonido/39-el-sonido-es-una-onda-mecanica.md).
