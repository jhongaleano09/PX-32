# Lección 58 — Wi-Fi y Bluetooth no son lo mismo

## 1. Tu misión de hoy

Hoy vas a **elegir la tecnología adecuada para tres situaciones**. Al terminar podrás demostrarlo con una explicación, un dato o un comportamiento observable; no basta con decir “funcionó”.
...
[Lección 52: Qué hace Bluetooth](../06-bluetooth/52-que-hace-bluetooth.md), [Lección 57: Control Bluetooth con parada dominante](../06-bluetooth/57-control-bluetooth-con-parada-dominante.md). Debes poder explicar su idea central y repetir su prueba segura antes de continuar.
...
El tema de hoy es **WLAN, enlace, infraestructura y alcance**. En lenguaje cotidiano, buscamos una forma fiable de elegir la tecnología adecuada para tres situaciones. La palabra “fiable” importa: una sola coincidencia puede ser suerte; una explicación científica conecta una causa, una prueba y un resultado que otra persona podría repetir.
...
- **Wlan:** idea principal que podrás reconocer en la actividad.
...
1. ¿Qué esperas observar cuando logres elegir la tecnología adecuada para tres situaciones y qué mecanismo produciría ese resultado?
...
1. **Preparar.** Coloca PX-32 estable, identifica HW-003, HW-011 y confirma con el adulto que la energía está en el estado seguro. Continúa solo si no hay cables sueltos, daño, calor u olor.
2. **Trazar.** Señala la ruta entrada → proceso → salida relacionada con WLAN, enlace, infraestructura y alcance. Si no puedes justificar un pin, consulta el mapa; no adivines.
3. **Predecir.** Elige un resultado concreto y una señal de parada. Di qué variable cambiarás y cuáles permanecerán iguales.
4. **Probar.** Vas a comparar conexión directa, red local y acceso mediante router. Haz un solo cambio. Observa antes de repetir y mantén accesible la forma de detener la prueba.
5. **Comprobar.** El resultado que permite continuar es: decisiones justificadas por arquitectura, no solo por distancia. Si no aparece, apaga cuando corresponda y pasa a “Si no funciona”.
...
El resultado normal es **decisiones justificadas por arquitectura, no solo por distancia**. Puede haber variación por tolerancias, superficie, luz, fricción, carga, eco o tiempos del programa. Una variación pequeña y repetible es información; un salto grande, un reinicio, una lectura imposible o un movimiento inesperado exige STOP.
...
- Cuéntale con tus palabras qué significa **WLAN** y dónde aparece en PX-32.
...
Hoy aprendiste a **elegir la tecnología adecuada para tres situaciones** y lo conectaste con **WLAN, enlace, infraestructura y alcance**. Pudiste observar decisiones justificadas por arquitectura, no solo por distancia. La regla de seguridad es cambiar conexiones únicamente sin energía y usar `STOP` ante información dudosa. La próxima sesión será la [Lección 59: El ESP8266/ESP-12S](59-el-esp8266-esp-12s.md).
