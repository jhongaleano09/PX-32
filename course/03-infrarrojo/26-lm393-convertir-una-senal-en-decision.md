...
Hoy vas a **explicar cómo una variación continua se transforma en 0 o 1**. Al terminar podrás demostrarlo con una explicación, un dato o un comportamiento observable; no basta con decir “funcionó”.
...
[Lección 25: Reflexión y absorción](25-reflexion-y-absorcion.md). Debes poder explicar su idea central y repetir su prueba segura antes de continuar.
...
El tema de hoy es **comparador, umbral, entrada analógica y salida digital**. En lenguaje cotidiano, buscamos una forma fiable de explicar cómo una variación continua se transforma en 0 o 1. La palabra “fiable” importa: una sola coincidencia puede ser suerte; una explicación científica conecta una causa, una prueba y un resultado que otra persona podría repetir.
...
- **Comparador:** idea principal que podrás reconocer en la actividad.
...
1. ¿Qué esperas observar cuando logres explicar cómo una variación continua se transforma en 0 o 1 y qué mecanismo produciría ese resultado?
...
2. **Trazar.** Señala la ruta entrada → proceso → salida relacionada con comparador, umbral, entrada analógica y salida digital. Si no puedes justificar un pin, consulta el mapa; no adivines.
3. **Predecir.** Elige un resultado concreto y una señal de parada. Di qué variable cambiarás y cuáles permanecerán iguales.
4. **Probar.** Vas a observar LED/OUT al cruzar lentamente la distancia de detección. Haz un solo cambio. Observa antes de repetir y mantén accesible la forma de detener la prueba.
5. **Comprobar.** El resultado que permite continuar es: un punto de cambio y posible pequeña zona inestable cerca del umbral. Si no aparece, apaga cuando corresponda y pasa a “Si no funciona”.
...
El resultado normal es **un punto de cambio y posible pequeña zona inestable cerca del umbral**. Puede haber variación por tolerancias, superficie, luz, fricción, carga, eco o tiempos del programa. Una variación pequeña y repetible es información; un salto grande, un reinicio, una lectura imposible o un movimiento inesperado exige STOP.
...
- Cuéntale con tus palabras qué significa **comparador** y dónde aparece en PX-32.
...
Hoy aprendiste a **explicar cómo una variación continua se transforma en 0 o 1** y lo conectaste con **comparador, umbral, entrada analógica y salida digital**. Pudiste observar un punto de cambio y posible pequeña zona inestable cerca del umbral. La regla de seguridad es cambiar conexiones únicamente sin energía y usar `STOP` ante información dudosa. La próxima sesión será la [Lección 27: El potenciómetro ajusta el umbral](27-el-potenciometro-ajusta-el-umbral.md).
